...
_ENTITY_ICONS: dict[str, str] = {
    ...
    "heatingreleased": "mdi:radiator",
    "coolingreleased": "mdi:snowflake",
    "compressorreleased": "mdi:turbine",
    "additionreleased": "mdi:lightning-bolt",
    "unit_state": "mdi:power",
    "freeze_protection_active": "mdi:snowflake-alert",
    "compressor_blocked": "mdi:cancel",
    "wifi_connected": "mdi:wifi",
    ...
    "active_alarms": "mdi:alert-circle-outline",
    "alarm_active": "mdi:alert",
    **{f"alarm_{index}_code": "mdi:alert" for index in range(1, 6)},
