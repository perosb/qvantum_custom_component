...
class QvantumFanEntity(CoordinatorEntity, FanEntity):
    ...
    def __init__(self, coordinator: QvantumDataUpdateCoordinator, metric_key: str, device: DeviceInfo) -> None:
        ...
        self._attr_preset_modes: list[str] = [FAN_SPEED_STATE_OFF, FAN_SPEED_STATE_NORMAL, FAN_SPEED_STATE_EXTRA]
    ...
    def is_on(self):
        ...
        return self.coordinator.data.get("settings").get(self._metric_key) != FAN_SPEED_STATE_OFF
