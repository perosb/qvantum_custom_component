"""Modbus register maps for the Qvantum heat pump.

These maps are the datasheet. ``model`` builds typed components from them,
and ``device`` adapts decoded values to the HTTP-shaped payloads the rest of
...
MODBUS_INPUT_REGISTER_MAP = {
    ...
    "compressor_run_time": (88, "uint16", 1.0),
    "compressor_starts": (89, "uint16", 1.0),
    "ventilation_fan_run_time": (90, "uint16", 1.0),
...
MODBUS_HOLDING_REGISTER_MAP = {
    ...
    "curve_minus_30": (24, "uint16", 1.0),
    "curve_minus_20": (25, "uint16", 1.0),
    "curve_minus_10": (26, "uint16", 1.0),
...
MODBUS_HOLDING_TO_SETTINGS_MAP = {
    ...
    "curve_minus_20": "curve_minus_20",
    "curve_minus_10": "curve_minus_10",
    "curve_0": "curve_0",
    "curve_10": "curve_10",
    "curve_20": "curve_20",
    "curve_30": "curve_30",
