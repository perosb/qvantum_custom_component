...
# Run tests
echo "Running pytest..."
PYTHONPATH=/home/perosb/build/qvantum_custom_component:/home/perosb/build/qvantum_custom_component/custom_components python -m pytest tests/test_api.py tests/test_init.py -v --tb=short --cov=custom_components.qvantum --cov-report=xml
